...
namespace Game
{
    ...
    public class DamagePopupManager : Singleton<DamagePopupManager>
    {
        ...
        {
            Fighter.RequestDamagePopup += SpawnDamageCounter;
            Crate.RequestDamagePopup += SpawnDamageCounter;
        }
        ...
        /// color.</param>
        public void SpawnDamageCounter(Vector3 origin, int damage,
            bool critical)
        {
            ...
            damageIndicator.SetDamageText(damage, critical);
